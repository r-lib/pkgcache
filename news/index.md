...
- `repo_set()` and the `ppm_*()` functions,
  e.g. [`ppm_snapshots()`](https://r-lib.github.io/pkgcache/reference/ppm_snapshots.md),
...
- Metadata cache functions,
  e.g. [`meta_cache_deps()`](https://r-lib.github.io/pkgcache/reference/meta_cache_deps.md)
