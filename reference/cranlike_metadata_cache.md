...
cmc$list()
#> 
#> ✔ Updated metadata database: 5.57 MB in 4 files.
#> 
#> ℹ Updating metadata database
#> ✔ Updating metadata database ... done
#> 
#> # A data frame: 47,202 × 32
#>    package    version depends imports suggests needscompilation license
#>    <chr>      <chr>   <chr>   <chr>   <chr>    <chr>            <chr>  
#>  1 a11yShiny  0.1.3   R (>= … shiny … "devtoo… NA               EUPL-1…
#>  2 a5R        0.3.1   R (>= … cli, r… "arrow,… NA               Apache…
#>  3 aae.pop    0.2.0   R (>= … stats,… "knitr,… NA               Apache…
#>  4 AalenJoha… 1.0     NA      NA      "knitr,… NA               GPL (>…
#>  5 aamatch    0.4.5   R (>= … iTOS, … "DOS2, … NA               GPL-2  
#>  6 AATtools   0.0.3   R (>= … magrit…  NA      NA               GPL-3  
#>  7 ABACUS     1.0.0   R (>= … ggplot… "rmarkd… NA               GPL-3  
#>  8 abasequen… 0.1.0   NA      NA       NA      NA               GPL-3  
#>  9 abbreviate 0.1     NA      NA      "testth… NA               GPL-3  
#> 10 abc        2.2.2   R (>= … NA       NA      NA               GPL (>…
#> # ℹ 47,192 more rows
...
#>  4 igraph    2.2.3   methods… "cli, … "ape (>… NA               GPL (>…
...
#> 13 igraph    2.2.3   methods… "cli, … "ape (>… yes              GPL (>…
