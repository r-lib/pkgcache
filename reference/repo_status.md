...
#> 1 RSPM   http… cran… NA           source   src/… 4.5       TRUE  0.251 
#> 2 CRAN   http… cran  NA           source   src/… 4.5       TRUE  0.0509
#> 3 BioCs… http… bioc  3.22         source   src/… 4.5       TRUE  0.163 
#> 4 BioCa… http… bioc  3.22         source   src/… 4.5       TRUE  0.193 
#> 5 BioCe… http… bioc  3.22         source   src/… 4.5       TRUE  0.193 
#> 6 BioCw… http… bioc  3.22         source   src/… 4.5       TRUE  0.238 
#> 7 BioCb… http… bioc  3.22         source   src/… 4.5       TRUE  0.246 
...
#> RSPM          @ packagemanager.posit.co (R 4.0)              ✔                       ✔              (14.7s)
#> CRAN          @ cran.rstudio.com        (R 4.0)              ✔                       ✔              (182ms)
#> RSPM          @ packagemanager.posit.co (R 4.1)              ✔                       ✔              (12.7s)
#> CRAN          @ cran.rstudio.com        (R 4.1)              ✔                       ✔              (182ms)
#> BioCsoft      @ bioconductor.org        (R 4.0)              ✔                       ✔              (5.3s )
#> BioCann       @ bioconductor.org        (R 4.0)              ✔                       ✔              (5.3s )
#> BioCexp       @ bioconductor.org        (R 4.0)              ✔                       ✔              (5.3s )
#> BioCworkflows @ bioconductor.org        (R 4.0)              ✔                       ✔              (5.3s )
#> BioCbooks     @ bioconductor.org        (R 4.0)              ✔                       ✔              (405ms)
#> BioCsoft      @ bioconductor.org        (R 4.1)              ✔                       ✔              (5.3s )
#> BioCann       @ bioconductor.org        (R 4.1)              ✔                       ✔              (5.5s )
#> BioCexp       @ bioconductor.org        (R 4.1)              ✔                       ✔              (5.4s )
#> BioCworkflows @ bioconductor.org        (R 4.1)              ✔                       ✔              (5.3s )
#> BioCbooks     @ bioconductor.org        (R 4.1)              ✔                       ✔              (322ms)
```
